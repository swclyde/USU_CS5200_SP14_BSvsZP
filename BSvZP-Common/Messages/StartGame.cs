...
namespace Messages
{
    public class StartGame : Request
    {
        ...
        private static Int16 ClassId { get { return (Int16)MESSAGE_CLASS_IDS.StartGame; } }
        #endregion
        ...
        /// </summary>
        public StartGame() : base(PossibleTypes.StartGame) { }
        ...
        public StartGame(Int16 gameId)
            : base(PossibleTypes.StartGame)
        {
            GameId = gameId;
        }
        ...
        new public static StartGame Create(ByteList bytes)
        {
