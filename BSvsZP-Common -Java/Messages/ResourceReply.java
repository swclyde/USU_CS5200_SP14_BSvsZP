...
public class ResourceReply extends Reply {
	...
	public static ResourceReply Create(ByteList messageBytes) throws Exception
    {
	 ...
	 @Override public void Encode(ByteList bytes) throws ApplicationException, IOException, Exception
     {
     ...
     @Override public void Decode(ByteList bytes) throws ApplicationException, IOException, Exception
     {
