...
namespace Messages
{
    public class StartUpdateStream : Request
    {
        #region Private Properties
        private static Int16 ClassId { get { return (Int16)MESSAGE_CLASS_IDS.StartUpdateStream; } }
        #endregion
        ...
        /// </summary>
        public StartUpdateStream() : base(PossibleTypes.StartUpdateStream) { }
        ...
        new public static StartUpdateStream Create(ByteList bytes)
        {
