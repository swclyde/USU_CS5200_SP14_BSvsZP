...
namespace Messages
{
    public class ExitGame : Request
    {
        ...
        /// </summary>
        public ExitGame() : base(PossibleTypes.ExitGame) { }
        ...
        public ExitGame(Int16 gameId)
            : base(PossibleTypes.ExitGame)
        {
            GameId = gameId;
        }
        ...
        new public static ExitGame Create(ByteList messageBytes)
        {
